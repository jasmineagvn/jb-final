      ...
      <section className="text-center mt-20 md:mt-42 px-4">
        ...
        <div className="max-w-6xl mx-auto flex flex-wrap justify-center md:gap-24 mt-0 mb-32">
            <div className="flex flex-wrap w-[315px] h-[247px]">
                <img src="./public/icons/sdgs1.png" className="max-w-full h-auto object-contain" />
            </div>
            <div className="flex flex-wrap justify-center w-[315px] h-[247px]">
                <img src="./public/icons/global.png" className="max-w-full h-auto object-contain" />
            </div>
            <div className="flex flex-wrap w-[315px] h-[247px]">
                <img src="./public/icons/sdgs3.png" className="max-w-full h-auto object-contain"/>
            </div>
        </div>
      </section>
    );
