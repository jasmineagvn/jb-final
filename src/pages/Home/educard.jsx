...
const Card = ({icon, title, description, button}) => (
    <div className="rounded-xl p-6 dark:bg-[#3C3F41] shadow-2xl gap-5 flex flex-col items-center">
        <div className="text-xl text-cyan-600  mb-4">{icon}</div>
        <h2 className="text-xl dark:text-white font-semibold mb-2">{title}</h2>
        <p className="text-gray-600 dark:text-gray-300 text-sm mb-6 flex-1 text-center">{description}</p>
...
const EducationCards = () => {
    return (
        <div className="max-w-6xl mx-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-6 mt-32">
            <Card
