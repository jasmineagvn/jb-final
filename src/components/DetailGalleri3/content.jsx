  ...
  return (
    <div className="mt-16">
      ...
      <div className="max-w-6xl mx-auto mt-10">
        ...
        Graduation Siswa Janji Baik
        </h1>

        <div className="mt-12 flex flex-col gap-4 px-5 md:px-0">
          <img src="/icons/galeri5/gambar1.png" alt="" />
          <div className="flex flex-wrap justify-between gap-4">
            <img
              src="/icons/galeri5/gambar2.png"
              alt=""
              className="w-[565px]"
            />
            <img
              src="/icons/galeri5/gambar3.png"
              alt=""
              className="w-[565px]"
            />
            <img
              src="/icons/galeri5/gambar4.png"
              alt=""
              className="w-[565px]"
            />
            <img
              src="/icons/galeri5/gambar5.png"
              alt=""
              className="w-[565px]"
            />
          </div>
          <div className="flex flex-wrap justify-between gap-4">
            <img src="/icons/galeri5/gambar6.png" alt="" className="w-[565px]" />
            <div className="w-[565px] flex flex-wrap gap-4">
              <img src="/icons/galeri5/gambar7.png" alt="" className="h-[341px]" />
              <img src="/icons/galeri5/gambar7.png" alt="" className="h-[341px]" />
              <img src="/icons/galeri5/gambar7.png" alt="" className="h-[341px]" />
            </div>
          </div>
