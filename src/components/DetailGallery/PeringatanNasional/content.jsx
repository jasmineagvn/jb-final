    ...
    <div className="mt-16">
      ...
      <div className="max-w-6xl mx-auto mt-10">
        ...
        <div className="mt-12 flex flex-col gap-4 px-5 md:px-0">
          <img src="/icons/PeringatanNasional/gambar1.png" alt="" />
          <div className="flex flex-wrap justify-between gap-4">
            <img
              src="/icons/PeringatanNasional/gambar2.png"
              alt=""
              className="w-[565px]"
            />
            <img
              src="/icons/PeringatanNasional/gambar3.png"
              alt=""
              className="w-[565px]"
            />
            <img
              src="/icons/PeringatanNasional/gambar4.png"
              alt=""
              className="w-[565px]"
            />
            <img
              src="/icons/PeringatanNasional/gambar5.png"
              alt=""
              className="w-[565px]"
            />
          </div>
