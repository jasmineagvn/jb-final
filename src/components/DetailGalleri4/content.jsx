    ...
    <div className="mt-16">
      ...
      <div className="max-w-6xl mx-auto mt-10">
        ...
        <div className="mt-12 flex flex-col gap-4 px-5 md:px-0">
          <img src="/icons/galeri6/gambar1.png" alt="" />
          <div className="flex flex-wrap justify-between gap-4">
            <img
              src="/icons/galeri6/gambar2.png"
              alt=""
              className="w-[565px]"
            />
            <img
          ...
          <div className="flex flex-wrap justify-between gap-4">
            <img
              src="/icons/galeri6/gambar3.png"
              alt=""
              className="w-[565px]"
            />
            <div className="flex flex-wrap w-[565px] gap-4">
              <img
                src="/icons/galeri6/gambar4.png"
                alt=""
                className="h-[385px]"
              />
              <img
                src="/icons/galeri6/gambar5.png"
                alt=""
                className="h-[385px]"
              />
              <img
                src="/icons/galeri6/gambar6.png"
                alt=""
                className="h-[385px]"
              />
            </div>
          ...
          <div className="flex flex-wrap justify-between gap-4">
            <div className="flex flex-wrap w-[565px] gap-4">
              <img
                src="/icons/galeri6/gambar7.png"
                alt=""
                className="h-[385px]"
              />
              <img
                src="/icons/galeri6/gambar8.png"
                alt=""
                className="h-[385px]"
              />
              <img
