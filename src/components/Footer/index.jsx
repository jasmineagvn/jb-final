    ...
    <footer className="md:p-[92px] px-5 py-20 bg-[#01B4BB] relative h-full w-full mt-20">
      ...
      <div className="md:relative flex flex-wrap md:flex-row gap-9 md:gap-0 justify-between">
        <div className="flex flex-col gap-6">
          ...
          <p className="text-sm text-white">Copyright ©2025 Janji Baik</p>
        </div>
        <div className="flex flex-col lg:flex-row lg:gap-20 gap-10 w-full md:w-[340px]">
          <div className="flex flex-col gap-5">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <a
                  href="/tentangkami"
                  className="text-base text-white whitespace-nowrap hover:underline underline-offset-4 transition-all duration-300"
                >
                  Tentang Kami
                </a>
              </li>
              <li>
                <a
                  href="/daftar"
                  className="text-base text-white hover:underline underline-offset-4 transition-all duration-300"
                >
                  Daftar
                </a>
              </li>
